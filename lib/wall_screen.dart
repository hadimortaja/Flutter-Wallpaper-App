...
class _WallScreenState extends State<WallScreen> {
  ...
  BannerAd showBannerAd(){
    return BannerAd(
        adUnitId:"ca-app-pub-3019071775174380/4610968394",
        size: AdSize.banner,
  ...
  InterstitialAd showInterstitialAd(){
    return InterstitialAd(
        adUnitId: "ca-app-pub-3019071775174380/4774619923",
        targetingInfo: targetingInfo,
        listener: (MobileAdEvent event) {
  ...
  void initState() {
    super.initState();
    FirebaseAdMob.instance.initialize(appId: "ca-app-pub-3019071775174380~2648926134");
